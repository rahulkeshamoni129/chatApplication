    ...
    <div className='flex h-screen items-center justify-center bg-black'>
        ...
        <br/>
            ...
            <div className='flex text-white justify-between' >
                <p>Have an account? 
                    <Link to='/login' className='text-blue-500 underline cursor-pointer ml-2'>Login</Link>
                </p>
                <input type='submit' value='signup' className='text-white bg-green-500 px-4 py-2 rounded-lg cursor-pointer'></input>
            </div>
        </form>
    </div>
  )
